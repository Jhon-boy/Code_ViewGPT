              ...
              <ListItemText>
                <Link to='/infoPage'>
                  <Tab
                    ...
                    label={<span style={{ color: 'black' }}>Información</span>}
                  />
                </Link>
              </ListItemText>
            </ListItemIcon>
              ...
              <ListItemText>
                <Link to='/contact'>
                  <Tab
                    ...
                    label={<span style={{ color: 'black' }}>Contáctos</span>} />
                </Link>
              </ListItemText>
            </ListItemIcon>
          </ListItemButton>
            ...
            <ListItemIcon>
              <Link to='help' >
                <Tab
                  ...
                  label={<span style={{ color: 'black' }}>Ayuda</span>} />
              </Link>
            </ListItemIcon>
          </ListItemButton>

          <div className="perfilBajo">
            {usuario === null || usuario === 'Anonimo' ? (
              ...
              <div>
                <Button
                  ...
                  variant="contained"
                >
                  <span style={{ color: 'white' }}>{usuario.email}</span>
                </Button>
                <Menu
                  id="basic-menu"
                  anchorEl={anchorEl}
